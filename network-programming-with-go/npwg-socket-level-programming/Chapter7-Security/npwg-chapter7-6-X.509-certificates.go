...
// A Public Key Infrastructure (PKI) is a framework for a collection of public keys, along with additional information
// such as owner name and location, and links between them giving some sort of approval mechanism.
